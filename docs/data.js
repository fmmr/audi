...
const RECURRING_FAULTS = [
    { category: 'hud', title: 'Filskifteassistent (lane change assist) virker ikke - IKKE forveksles med filholder',
      ...
      note: 'OBS til verksted: dette gjelder AKTIV filskifteassistent (bilen skifter fil på kommando via blinklys), IKKE filholderfunksjonen ("lane keep assist") under adaptiv cruise control. Verkstedet har allerede to ganger misforstått dette.' },
