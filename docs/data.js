...
const FAULTS = [
    ...
    {
        date: '2024-11-29',
        category: 'hud', source: 'observation', severity: 'kritisk',
        title: 'HUD sluttet å fungere/slukket helt under kjøring',
        description: 'Head-up-displayet har sluttet å fungere/slukket helt under kjøring, og ikke mulig å skru på via MMI.'
    },
    {
        date: '2024-12-12',
        category: 'hud', source: 'observation', severity: 'kritisk',
...
const RECURRING_FAULTS = [
    { category: 'mmi', title: 'Navigasjon: krever flere bekreftelser etter valg av destinasjon',
      description: 'Ved valg av sted å navigere til måtte man bekrefte flere ganger etter å ha valgt sted. Trafikkfarlig - hvert trykk på skjermen er fokus bort fra veien. Nå starter navigeringen umiddelbart når man velger et sted.',
    ...
    { category: 'klima', title: 'Klimaanlegg kommer på i tilfeldig innstilling - ofte helt av',
      ...
      observing: true, since: '2026-09-04' },
    { category: 'hud', title: 'Fartsoverskridelse-varsling: må stille to ganger',
      ...
      swFix: true, fixed: '2026-09-04' },
    { category: 'hud', title: 'Fartsoverskridelse-varsling: manglet hurtigknapp på ratt (som 2025-modellen)',
      description: 'Fartsoverskridelse-varsling 2: manglet mulighet til å bruke hurtigknappen på rattet til å skru av varslingen - måtte bla i menyer. Hurtigtast-tilordningen er nå på plass etter oppdateringen. (2025-modellen har i tillegg et mer behagelig lydvarsel; dette er ikke endret på denne bilen.)',
      swFix: true, fixed: '2026-09-04' },
...
const CONTACTS = [
    ...
    { date: '2026-09-04', type: 'refleksjon',
      title: 'Refleksjon rundt programvare og kundelojalitet',
      description: 'Den 27. august oppga Møller skriftlig at det ikke fantes ny programvare til min bil. En uke senere - da bilen ble levert inn med akutt ladefeil - var en omfattende storoppdatering likevel tilgjengelig og ble installert.\n\nFor meg som kunde fremstår forhandleren som passiv. Når en bil har hatt over 111 registrerte feil, forventer man at forhandleren forklarer situasjonen og kjemper kundens sak overfor fabrikken. I stedet oppleves det som at de bare godtar fabrikkens retningslinjer uten videre, i stedet for å utfordre systemet for å hjelpe kunden.\n\nAt tilgjengelige programvarefikser først utleveres etter et akutt ladesammenbrudd, svekker tilliten til forhandler og merkevare betydelig. Det gjør det krevende å ha tillit til oppfølgingen videre, og det påvirker naturligvis vurderingen ved fremtidige bilvalg.' },
    { date: '2026-09-04', type: 'verksted', partOfVisit: '2026-09-03',
    ...
    { date: '2026-09-21', type: 'verksted', partOfVisit: '2026-09-03', title: 'Planlagt: 2-års service + DC-ladefeil + oppfølging av øvrige feil (avlyst - utført under 3./4. september-besøket)',
    ...
    { date: '2025-04-14', type: 'verksted', partOfVisit: '2025-04-28', title: 'Innom Møller Billingstad - motorfeil før påske',
